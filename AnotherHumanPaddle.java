...
public class AnotherHumanPaddle implements Paddle {
    ...
    public AnotherHumanPaddle() {
        upAccel = false;
        downAccel = false;
        y = 210; // from where the paddle shows on the applet
        yVel = 0;
        x = 660;  // this shows the paddle at the right side of the applet
    }
    
    public void draw(Graphics g) {
        g.setColor(Color.red); // choosing the color for the paddle
